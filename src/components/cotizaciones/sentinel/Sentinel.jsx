...
import ModalSentinel from "./ModalSentinel";
import { FaEdit, FaPlus, FaTrash } from "react-icons/fa";

export default function Sentinel() {
  const [cotizaciones, setCotizaciones] = useState([
    { id: 1, fecha: "2024-06-01", cliente: "Cliente Uno", consecutivo: "3309", ordenVenta: "SA-1001", totalGeneral: 1500.00 },
  ]);
  const [modalOpen, setModalOpen] = useState(false);
  const [cotizacionEdit, setCotizacionEdit] = useState(null);
  const [proximoConsecutivo, setProximoConsecutivo] = useState(3310);
