...
export default function ConceptosTi() {
  const [cotizaciones, setCotizaciones] = useState([
    { id: 1, fecha: "2024-06-01", cliente: "Cliente Uno", consecutivo: "3209", ordenVenta: "CP-1001", totalGeneral: 1500.00 },
  ]);
  const [modalOpen, setModalOpen] = useState(false);
  const [cotizacionEdit, setCotizacionEdit] = useState(null);
  const [proximoConsecutivo, setProximoConsecutivo] = useState(3210);
